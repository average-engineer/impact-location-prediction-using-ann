...
# 4 arrays taken randomly from the list of arrays with impact locations on the axis
# 24 arrays taken randomly from each list corresponding to the quadrants
...
trainList = [*axis,*q1,*q2,*q3,*q4]
valList = [*axisVal,*q1Val,*q2Val,*q3Val,*q4Val]
...
np.savetxt('saved_variables/Balanced_Data/Oxy_train.txt',Oxy_train)
np.savetxt('saved_variables/Balanced_Data/Oxy_val.txt',Oxy_val)
Sxy_train_rshpd = Sxy_train.reshape(Sxy_train.shape[0], -1)
np.savetxt('saved_variables/Balanced_Data/Sxy_train.txt',Sxy_train_rshpd)
Sxy_val_rshpd = Sxy_val.reshape(Sxy_val.shape[0], -1)
np.savetxt('saved_variables/Balanced_Data/Sxy_val.txt',Sxy_val_rshpd)

np.savetxt('saved_variables/Balanced_Data/Oxy.txt',Oxy)
Sxy_rshpd = Sxy.reshape(Sxy.shape[0], -1)
np.savetxt('saved_variables/Balanced_Data/Sxy.txt',Sxy_rshpd)
